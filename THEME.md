# Scruggs & Co — Visual System v3

## Concept: “Garden Ledger”

Same documentary structure — curtains, procession, galleries — restyled as a warm field notebook: oat paper, sage, terracotta, and a little handwriting.

### Palette

| Token | Hex | Use |
|-------|-----|-----|
| `--paper` | `#F4ECE1` | Page ground — warm oat |
