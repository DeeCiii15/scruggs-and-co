...
export default function ContinuumReviews() {
  return (
    <section
      id="testimonials"
      className="fl-letters relative min-h-svh scroll-mt-24 overflow-x-clip bg-paper px-5 py-16 sm:px-10 sm:py-20 lg:px-16"
    >
      <div className="relative z-[2] mx-auto max-w-6xl text-center">
        ...
        <h2 className="mt-3 font-display text-sm text-ink-soft sm:text-base">
